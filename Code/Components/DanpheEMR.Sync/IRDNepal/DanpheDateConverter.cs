...
namespace DanpheEMR.Sync.IRDNepal.Utilities
{
    ...
    public static class NepaliDateModel
    {
        ...
        public static IReadOnlyDictionary<int, List<int>> LoadNepYear_MthHash()
        {
            ...
            {2081,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31} },//pass
            {2082,new List<int>{31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30} },//pass
            {2083,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },//verify again
            {2084,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },//verify again
            {2085,new List<int>{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31} },//verify again
            {2086,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },//verify again
            {2087,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} },//verify again
            {2088,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },//verify again
            {2089,new List<int>{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31} },//verify again
            {2090,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },//verify again
            {2091,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} },//verify again
            {2092,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },//verify again
            {2093,new List<int>{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31} },//verify again
            {2094,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },//verify again
            {2095,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} },//verify again
            {2096,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },//verify again
            {2097,new List<int>{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30} },//verify again
            {2098,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },//verify again
            {2099,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} } //verify again
            };
            return Localyr_mth;
        }
