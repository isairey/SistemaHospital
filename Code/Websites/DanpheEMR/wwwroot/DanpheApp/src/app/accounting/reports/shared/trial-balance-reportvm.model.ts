export class TrialBalanceReportVM {
    ...
    public OpeningTotalDr: number = 0;
    public OpeningTotalCr: number = 0;
    ...
    public ClosingDr: number = 0;
    public ClosingCr: number = 0;
    public ClosingTotalDr: number = 0;
    public ClosingTotalCr: number = 0;
