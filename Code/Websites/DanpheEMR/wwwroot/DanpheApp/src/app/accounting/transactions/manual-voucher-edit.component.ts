...
export class ManualVoucherEditComponent {
  ...
  public ActiveHospital: number = 1;
  ...
  constructor(
    ...
    this.ActiveHospital = this._securityService.AccHospitalInfo.ActiveHospitalId;
  }
  ...
  ViewTransactionDetails() {
    try {
      if (this.voucher.VoucherCode && this.voucher.VoucherCode.trim()) {
        ...
        this.msgBoxServ.showMessage(ENUM_MessageBox_Status.Error, ["Please Enter Valid Voucher Number."]);
      }
