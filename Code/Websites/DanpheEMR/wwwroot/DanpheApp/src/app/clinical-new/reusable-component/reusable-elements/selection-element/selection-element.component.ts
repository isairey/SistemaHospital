...
@Component({
    selector: "selection-element",
    templateUrl: "./selection-element.component.html",
    styleUrls: ["../reusable-elements.component.css"]
})
export class ClinicalReusableSelectionElement implements OnInit, IDynamicElement {
    Field: Field;
    Question: QuestionaryConfig;
    // FieldConfig: SingleSelectionConfig;
    ...
    EditField(field: Field, data: ClinicalData_DTO) {
        ...
        field.FieldConfig.form.get(`${field.FieldId}.option`).patchValue(data.ClinicalOptionsData[0].OptionId);
    ...
    UpdateFieldValue() {
        ...
        singleSelectMultipleSelect.OptionAnswers = this.Field.FieldConfig.form.get(`${this.Field.FieldId}.option`).value ? [{
            ...
            OptionId: this.Field.FieldConfig.form.get(`${this.Field.FieldId}.option`).value
        }] : [];
    ...
    EditQuestionField(question: QuestionaryConfig, options: { IsInEditMode: boolean, QuestionOptions: ClinicalQuestionOption_DTO[]; }) {
        ...
        question.FieldConfig.form.get(`${question.QuestionId}.option`).patchValue(options.QuestionOptions[0].QuestionOptionId);
    ...
    UpdateQuestionFieldValue() {
        ...
        singleSelectMultipleSelect.QuestionarySingleSelectMultipleSelectData = {
            ...
            OptionAnswers: this.Question.FieldConfig.form.get(`${this.Question.QuestionId}.option`).value ? [{ ClinicalAnswerOptionId: 0, QuestionOptionId: this.Question.FieldConfig.form.get(`${this.Question.QuestionId}.option`).value }] : []
        };
