...
@Component({
  selector: 'smart-printable-hospital-header',
  templateUrl: './smart-printable-hospital-header.html'
})

export class SmartPrintableHospitalHeaderComponent {
  ...
  ngOnInit(): void {
    ...
    this.TemplateCode = ENUM_ClinicalHeaderType.hospital;
