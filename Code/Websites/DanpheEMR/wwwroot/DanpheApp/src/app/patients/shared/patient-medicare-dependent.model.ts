...
export class MedicareDependentModel {
    ...
    public DependentMemberNo: string;
    ...
    constructor() {
        ...
        this.MedicareDependentValidator = _formBuilder.group({
            ...
            'DependentMemberNo': ['', Validators.compose([Validators.required])],
        });
    }
...
export class MedicareDependentData {
    public MedicareMemberNo: number = 0;
