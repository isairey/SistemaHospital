...
@Component({
  selector: "common-fiscal-year-calendar",
  templateUrl: "./common-fiscal-year-calendar.html",
  styleUrls: ['./common-fiscal-year-calendar.css']
})

// Bibek12thMarch'24 : Initially created to use this common fiscal year calander to be used in common 
export class CommonFiscalYearCalendarComponent implements OnInit {
  public HospitalInfoMaster: CommonHospitalInfoVM;
  ...
  constructor(private securityService: SecurityService, private changeDetector: ChangeDetectorRef,
    ...
    this.HospitalInfoMaster = (this.securityService.ModuleNameForFiscalYear == "Billing") ? this.HospitalInfoMaster : this.securityService.CommonHospitalInfo;
