...
import { ClinicalNotes_DTO } from './DTOs/clinical-notes.dto';
...
export class SettingsBLService {
  ...
  public AddSalutation(data: Salutation) {
    return this.settingsDLService.PostSalutation(data)
      .map(res => { return res; });
  }
  public UpdateSalutation(data: Salutation) {
    return this.settingsDLService.UpdateSalutation(data)
      .map(res => { return res; });
  }
  public ActivateDeactivateSalutation(selectedIntakeTimingId) {
    return this.settingsDLService.PutActivateDeactivateSalutationStatus(selectedIntakeTimingId)
      .map((res: DanpheHTTPResponse) => { return res; });
  }
  //start: adt
  public GetHospitalAccount() {
    return this.settingsDLService.GetHospitalAccount()
      .map(res => { return res; });
  }
  public GetInventoryFiscalYear() {
    return this.settingsDLService.GetInventoryFiscalYear()
      .map(res => { return res; });
  }
  public GetAccountFiscalyear() {
    return this.settingsDLService.GetAccountFiscalyear()
      .map(res => { return res; });
  }
  public GetBillFiscalyear() {
    return this.settingsDLService.GetBillFiscalyear()
      .map(res => { return res; });
  }
  public GetPharmacyFiscalyear() {
    return this.settingsDLService.GetPharmacyFiscalyear()
      .map(res => { return res; });
  }
  public AddPharmacyFiscalyear(AddPharmacyYear) {
    return this.settingsDLService.AddPharmacyFiscalyear(AddPharmacyYear)
      .map(res => { return res; });
  }
  public AddINVFiscalyear(AddInentoryYear) {
    return this.settingsDLService.AddINVFiscalyear(AddInentoryYear)
      .map(res => { return res; });
  }
  public AddAccountFiscalyear(AddAccountingYear) {
    return this.settingsDLService.AddAccountFiscalyear(AddAccountingYear)
      .map(res => { return res; });
  }
  public AddBillFiscalyear(AddBillingYear) {
    return this.settingsDLService.AddBillFiscalyear(AddBillingYear)
      .map(res => { return res; });
  }
  public AddBillingCounter(updatedValue) {
    return this.settingsDLService.AddBillingCounter(updatedValue)
      .map(res => { return res; });
  }

  public GetBillingCounter() {
    return this.settingsDLService.GetBillingCounter()
      .map(res => { return res; });
  }

  public ActivateDeactivateBillingCounter(billCounter: Bill_Counter): Observable<DanpheHTTPResponse> {
    return this.settingsDLService.ActivateDeactivateBillingCounter(billCounter)
      .map(res => { return res; });
  }
  public GetBedList() {
  ...
  public GetSchemesForReport() {
    return this.settingsDLService.GetSchemesForReport()
      .map(res => { return res; });
  }
  ...
  //get radiology template style 
  public GetTemplateStyleList() {
    try {
      return this.settingsDLService.GetTemplateStyleList()
        .map(res => { return res });
  ...
  //add radiology template style 
  AddNewTemplateStyle(newTemplateStyle: RadiologyTemplateStyleDto) {
    return this.settingsDLService.PostNewTemplateStyle(newTemplateStyle)
      .map(res => {
        return res
      });
  }
  //update radiology template style  
  UpdateTemplateStyle(newTemplateStyle: RadiologyTemplateStyleDto) {
    return this.settingsDLService.PutTemplateStyle(newTemplateStyle).map(res => { return res });
  }
  //update IsActiveStatus
  UpdateIsActiveStatus(templateStyleId: number) {
    return this.settingsDLService.PutTemplateStyleIsActiveStatus(templateStyleId).map(res => { return res });
  }
  public GetImgTypes() {
  ...
  //Get Active Raddiology report  template list
  public GetActiveReportTemplatesList() {
    try {
      return this.settingsDLService.GetActiveReportTemplatesList().map(res => { return res; });
    } catch (exception) {
      throw exception;
    }
  }
  ...
  public AddImagingItem(imagingItem: ImagingItem_DTO) {
  ...
  public UpdateImagingItem(imagingItem: ImagingItem_DTO) {
    //to fix serializaiton problem in server side
  ...
  public GetServiceItemListBySchemeId(schemeId: number) {
    return this.settingsDLService.GetServiceItemListBySchemeId(schemeId)
      .map(res => { return res; });
  }
  ...
  public GetRegistrationStickerSettingsData() {
    return this.settingsDLService.GetRegistrationStickerSettingsData()
      .map(res => { return res; });
  }
  public AddRegistrationStickerData(currentRegistrationStickerData: RegistrationSticker_DTO) {
    return this.settingsDLService.PostRegistrationStickerData(currentRegistrationStickerData)
      .map(res => { return res; });
  }
  public UpdateRegistrationStickerData(currentRegistrationStickerData: RegistrationSticker_DTO) {
    return this.settingsDLService.UpdateRegistrationStickerData(currentRegistrationStickerData)
      .map(res => { return res; });
  }

  public ActivateDeactivateRegistrationStickerStatus(registrationStickerSettingsId: number, isActive: boolean) {
    return this.settingsDLService.ActivateDeactivateRegistrationStickerStatus(registrationStickerSettingsId, isActive)
      .map(res => { return res; });
  }
  public AddClinicalNote(clinicalNotes: ClinicalNotes_DTO) {
    let temp = _.omit(clinicalNotes, ['ClinicalNoteValidator']);
    return this.settingsDLService.AddClinicalNote(temp)
      .map(res => { return res; });
  }

  public clinicalNoteList() {
    return this.settingsDLService.clinicalNoteList()
      .map(res => { return res; });
  }

  public UpdateClinicalNote(clinicalNotes: ClinicalNotes_DTO) {
    let temp = _.omit(clinicalNotes, ['ClinicalNoteValidator']);
    return this.settingsDLService.UpdateClinicalNote(temp)
      .map(res => { return res; });
  }
  public GenerateItemCode(itemName: string) {
    return this.settingsDLService.GenerateItemCode(itemName)
      .map(res => { return res; });
  }

  public SavePrintFormat(printTemplate: AddPrintTemplateSettings_DTO) {
    return this.settingsDLService.SavePrintFormat(printTemplate)
      .map(res => { return res; });
  }
  public GetAllPrintTemplates() {
    return this.settingsDLService.GetAllPrintTemplates()
      .map(res => { return res; });
  }
  public ActivateDeactivatePrintTemplate(printTemplateId: number) {
    return this.settingsDLService.ActivateDeactivatePrintTemplate(printTemplateId)
      .map(res => { return res; });
  }

  public UpdatePrintTemplate(printTemplate: PrintTemplateSettings_DTO) {
    return this.settingsDLService.UpdatePrintTemplate(printTemplate)
      .map(res => { return res; });
  }

  public GetPriceCategories() {
    return this.settingsDLService.GetPriceCategories()
      .map(res => { return res; });
  }

  public AddReportGroup(item) {
    return this.settingsDLService.PostReportGroup(item)
      .map(res => { return res; });
  }

  public GetReportGroup() {
    return this.settingsDLService.GetReportGroupList()
      .map(res => { return res; });
  }

  public UpdateReportGroup(item: ReportGroupModel) {
    let temp = _.omit(item, ['ReportGroupValidator']);
    return this.settingsDLService.UpdateReportGroup(temp)
      .map(res => { return res; });
  }

  public ReportGroupActivation(reportGroup: ReportGroupModel): Observable<DanpheHTTPResponse> {
    return this.settingsDLService.ReportGroupActivation(reportGroup)
      .map((res: DanpheHTTPResponse) => { return res; });
  }

  public GetActiveServiceItemList() {
    return this.settingsDLService.GetActiveServiceItemList()
      .map(res => { return res; });
  }

  public MapServiceItemsToReportGroup(serviceItemMappings) {
    return this.settingsDLService.MapServiceItemsToReportGroup(serviceItemMappings).map(res => { return res; });
  }

  public GetMappedServiceItemsByReportGroupId(SelectedDynamicReportGroupId: number) {
    return this.settingsDLService.GetMappedServiceItemsByReportGroupId(SelectedDynamicReportGroupId)
      .map(res => { return res; });
  }

  public GetAllLabTests() {
    return this.settingsDLService.GetAllLabTests()
      .map(res => { return res; });
  }

  public GetAllImagingItems() {
    return this.settingsDLService.GetAllImagingItems()
      .map(res => { return res; });
  }
  public GetFilteredServiceItemList(filterItems: FilterExportServiceItem_DTO): Observable<DanpheHTTPResponse> {
    return this.settingsDLService.GetFilteredServiceItemList(filterItems);
  }
}
